...
export const translations: Record<Language, TranslationSchema> = {
  en: {
    ...
    themeLabel: "THEME",
    heroSub: "Modular synthesizers and cybernetic sound structures.",
    heroDesc: "An experimental dark electronic music project merging analog synthesis with deep acoustic atmospheres. Experience custom live-synthesized loops and official releases.",
    ...
    vaultLabel: "OFFICIAL EP & ALBUM VAULT",
    vaultTitle: "Soundwave Chronicles",
    vaultDesc: "Select an album below to shift the visual theme dynamic and hear track previews synchronized from Spotify.",
    synthLabel: "INTERACTIVE HARDWARE HARMONICS",
    synthTitle: "Tactile Sound Synthesizer",
    synthDesc: "Synthesize loops live on the Web Audio engine. Select grid nodes or orbital controls below to trigger custom techno patterns and shape filters in real-time.",
    aboutHeading: "AESTHETIC DEVIATION MANIFESTO",
    aboutUnderground: "Minimalist electronic soundscapes designed for immersive spaces.",
    ...
    albumVoltaDesc: "A dual-faceted deep dive into the properties of time. 'VOLTA' explores the mechanical progression of linear schedules (Chronos) versus the opportune, suspended fluid moments of pure existence (Kairos). Intense modular rhythms colliding with dramatic string washes and cosmic stardust sweeps.",
    ...
    synthOverridesLabel: "SIGNAL PATH OVERRIDES (PRESETS)",
    ...
    contactCardDesc: "For live modular synthesizer showcases, curated remixes, release features, licensings, or raw Eurorack multitrack sequences, initiate terminal correspondence.",
  ...
  pt: {
    ...
    navSynth: "// Terminal de Voltagem",
    navManifesto: "// Manifesto",
    navInquiries: "// Contatos",
    audioOn: "ÁUDIO LIGADO",
    muted: "MUDO",
    sysOnline: "SISTEMA_ONLINE",
    vectorActive: "VETORIZAÇÃO DE SOM ATIVA",
    themeLabel: "TEMA",
    heroSub: "Sintetizadores modulares e estruturas sonoras cibernéticas.",
    heroDesc: "Um projeto experimental de música eletrônica dark mesclando síntese analógica com atmosferas acústicas profundas. Experimente loops customizados sintetizados ao vivo e lançamentos oficiais.",
    ...
    vaultLabel: "COFRE OFICIAL DE EPS E ÁLBUNS",
    vaultTitle: "Crônicas das Ondas Sonoras",
    vaultDesc: "Selecione um álbum abaixo para mudar a dinâmica do tema visual e ouvir prévias de faixas sincronizadas do Spotify.",
    synthLabel: "HARMÔNICOS DE HARDWARE INTERATIVOS",
    synthTitle: "Sintetizador de Som Tátil",
    synthDesc: "Sintetize loops ao vivo no mecanismo Web Audio. Selecione nós de grade ou controles orbitais abaixo para acionar padrões de techno personalizados e modelar filtros em tempo real.",
    aboutHeading: "MANIFESTO DE DESVIO ESTÉTICO",
    aboutUnderground: "Cenários sonoros eletrônicos minimalistas desenhados para espaços imersivos.",
    ...
    albumVoltaDesc: "Um mergulho multifacetado nas propriedades do tempo. 'VOLTA' contrapõe a rigidez linear do relógio mecânico (Chronos) à liberdade fluida do momento oportuno e suspenso de presença pura (Kairos). Ondas rítmicas agressivas colidem com melodias espaciais.",
    ...
    synthOverridesLabel: "PRESETS DE SINAL (ATALHOS)",
    ...
    contactCardDesc: "Para apresentações ao vivo com sintetizador modular, remixes exclusivos, mídias de licenciamento ou produção de lives, entre em contato direto pelo e-mail.",
  ...
  es: {
    ...
    navSynth: "// Terminal de Voltaje",
    navManifesto: "// Manifiesto",
    navInquiries: "// Contactos",
    audioOn: "AUDIO ACTIVADO",
    muted: "SILENCIADO",
    sysOnline: "SISTEMA_ONLINE",
    vectorActive: "VECTORIZACIÓN DE SONIDO ACTIVA",
    themeLabel: "TEMA",
    heroSub: "Sintetizadores modulares y estructuras sonoras cibernéticas.",
    heroDesc: "Un proyecto experimental de música electrónica oscura que fusiona la síntesis analógica con atmósferas acústicas profundas. Experimenta bucles personalizados sintetizados en vivo y lanzamientos oficiales.",
    ...
    vaultLabel: "CÓDICE OFICIAL DE EPS Y ÁLBUMES",
    vaultTitle: "Crónicas de Ondas Sonoras",
    vaultDesc: "Seleccione un álbum a continuación para cambiar la dinámica del tema visual y escuchar avances de pistas sincronizados de Spotify.",
    synthLabel: "ARMÓNICOS DE HARDWARE INTERACTIVOS",
    synthTitle: "Sintetizador de Sonido Táctil",
    synthDesc: "Sintetice bucles en vivo en el motor Web Audio. Seleccione nodos de cuadrícula o controles orbitales a continuación para activar patrones de techno personalizados y moldear filtros en tiempo real.",
    aboutHeading: "MANIFIESTO DE DESVIACIÓN ESTÉTICA",
    aboutUnderground: "Paisajes sonoros electrónicos minimalistas diseñados para espacios inmersivos.",
    ...
    albumVoltaDesc: "Un viaje profundo por las propiedades del tiempo. 'VOLTA' explora la progresión mecánica de cronogramas lineales (Chronos) versus el momento oportuno y suspendido de presencia pura (Kairos). Ritmos modulares intensos chocan con melodías de cuerdas estelares.",
    ...
    synthOverridesLabel: "PRESETS DE SEÑAL",
    ...
    contactCardDesc: "Para presentaciones en vivo con sintetizador modular, remixes exclusivos, licenciamientos o producciones, comuníquese directamente por correo electrónico.",
